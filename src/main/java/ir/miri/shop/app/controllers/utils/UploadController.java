package ir.miri.shop.app.controllers.utils;

import ir.miri.shop.app.enums.ResponseStatus;
import ir.miri.shop.app.helper.ui.ServiceResponse;
import ir.miri.shop.app.helper.ui.uimodels.people.UploadForm;
...
public class UploadController {
    ...
    public ServiceResponse<String> getListFiles() {
        ...
        ServiceResponse<String> x = new ServiceResponse<String>(ResponseStatus.SUCCESS, list);
        return x;
    }
