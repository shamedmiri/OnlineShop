app.controller('sliderListCtrl', function ($scope, apiHandler,$rootScope) {
    ...
    $scope.getDataList = () => {
        let url='/api/Slider/getAll?pageSize='+$scope.query.pageSize+'&pageNumber='+$scope.query.pageNumber;
    ...
    $scope.deleteItem=(id)=>{
        Swal.fire({
            ...
            if (result.isConfirmed) {
                apiHandler.callDelete('/api/Slider/'+id,(response)=>{
                    Swal.fire({
                        title: "Deleted!",
    ...
    $scope.changeOrder=(id,direction)=>{
        Swal.fire({
            ...
            if (result.isConfirmed) {
                debugger;
                apiHandler.callPost('/api/Slider/changeOrder/'+id+'/'+direction,null,(response)=>{
                    Swal.fire({
                        title: "Changed!",
